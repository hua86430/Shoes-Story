          ...
          <li class="nav-item ms-3">
            <router-link
              ...
              <p
                ...
                style="top:0px;right:45%;width:25px; background-color:gray;
                color:white; border-radius:50%;padding:1.5px"
              >
                {{ carts }}
              </p>
              <p v-else-if="isEmpty" class="position-absolute"></p>
              <p
                v-else
                class="position-absolute"
                style="top:0px;right:6px;width:25px; background-color:gray;
                color:white; border-radius:50%;padding:1.5px"
              >
                {{ carts }}
              </p>
